/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f1a2191300101a7ec8f59d26a49bd6f9)
...
interface __BaseEnv_Env {
	...
	TURNSTILE_SITE_KEY: "0x4AAAAAADVJiTpSvp2Bjq9A";
	TURNSTILE_SECRET_KEY: string;
	UPLOAD_YAJU_PIC_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_PUBLIC_BASE_URL" | "SITE_TIME_ZONE" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "UPLOAD_YAJU_PIC_SECRET">> {}
}
